# Generated by Django 3.0.5 on 2020-04-08 16:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.IntegerField(verbose_name=[('P', 'Purple'), ('Y', 'Yellow'), ('G', 'Green')])),
            ],
        ),
        migrations.CreateModel(
            name='Character',
            fields=[
                ...
                ('hat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Hat')),
            ],
        ),
    ]
